...
<section class="crear-producto-completa">
    ...
    <div class="crear-producto-div-form">
        <form action="acciones/usuarios-crear.php" method="post" enctype="multipart/form-data">
            <div class="crear-producto-fk">
                ...
                <div>
                    ...
                    <select 
                        ...
                        id="rol_fk" 
                    >
                        <option value="no-seleccion" selected disabled>Seleccionar una rol*</option>
                        <?php 
                        foreach($roles as $r): 
                        ?>
                        <option 
                            value="<?= $r->getRolId();  ?>" 
                            <?= $r->getRolId() == ($oldData['rol_fk'] ?? null) ? 'selected': '';?>
                        > 
                            <?= $r->getNombre(); ?>
                        </option>
                        <?php 
                    ...
                    <?php 
                    if(isset($errores['rol_fk'])):
                    ?>
                        <div data-error="form">
                            <p id="error-rol_fk"  class="form-text"><?= $errores['rol_fk'] ?></p>
                        </div>                
                    <?php 
                    endif;
                    ?>
